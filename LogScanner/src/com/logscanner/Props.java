...
public class Props {
	...
	private static final String sARCHIVE_REPORT_FILE="ARCHIVE_REPORT_FILE";
	...
	private static final String sEMAIL_REPORT = "EMAIL_REPORT";
	...
	private static final String sEMAIL_MAX_BODY_SIZE_IN_BYTES = "EMAIL_MAX_BODY_SIZE_IN_BYTES";
	private static final String sEMAIL_MAX_ATTACHED_FILE_SIZE_IN_BYTES = "EMAIL_MAX_ATTACHED_FILE_SIZE_IN_BYTES";
	private static final String sREPORT_FOLDER = "OUTPUT_FOLDER";

	// Filter values
	private String archiveReportFile = null;
	public String getArchiveReportFile() {
		return archiveReportFile;
	}

	public void setArchiveReportFile(String archiveReportFile) {
		this.archiveReportFile = archiveReportFile;
	}
	...
	// Email values
	protected String emailReport = null;
	...
	protected long maxEmailBodySizeBytes = 0;
	protected long maxEmailAttachedFileSizeBytes = 0;
	...
	protected void load() throws IOException {
		...
		if (file.exists()) {
			...
			setArchiveReportFile(pProps.getProperty(sARCHIVE_REPORT_FILE));
			setEmailReport(pProps.getProperty(sEMAIL_REPORT));
			...
			setMaxEmailBodySizeBytes(pProps
					.getProperty(sEMAIL_MAX_BODY_SIZE_IN_BYTES));
			setMaxEmailAttachedFileSizeBytes(pProps
					.getProperty(sEMAIL_MAX_ATTACHED_FILE_SIZE_IN_BYTES));
	...
	public void setMaxEmailBodySizeBytes(String sMaxEmailBodySizeBytes) {
		this.maxEmailBodySizeBytes = Long.parseLong(sMaxEmailBodySizeBytes);
	}

	public long getMaxEmailBodySizeBytes() {
		return maxEmailBodySizeBytes;
	}

	public void setMaxEmailAttachedFileSizeBytes(
			String sMaxEmailAttachedFileSizeBytes) {
		this.maxEmailAttachedFileSizeBytes = Long
				.parseLong(sMaxEmailAttachedFileSizeBytes);
	}

	public long getMaxEmailAttachedFileSizeBytes() {
		return maxEmailAttachedFileSizeBytes;
	}
